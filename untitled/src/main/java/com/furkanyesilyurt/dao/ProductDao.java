...
public class ProductDao extends BaseDao {
    /**   DATA ACCESS LAYER / OBJECT
        ...
        Yeni oluşturulan entityler için farklı bir com.furkanyesilyurt.dao classı oluşturulup BaseDao sınıfından extends edildikten sonra o class'a ait metotlar yazılabilir.
    */
    ...
    public List<ProductDetailDto> findAllUrunDetayDtoByKategoriKirilim(Long kirilim) {
        ...
        String sql = " select " +
                " new com.furkanyesilyurt.dto.ProductDetailDto( urun.adi, kategori.adi, urun.fiyat ) " +
                " from Product urun " +
                " left join Category kategori  on urun.kategori.id = kategori.id " +
                " where kategori.kirilim = :kirilim ";
